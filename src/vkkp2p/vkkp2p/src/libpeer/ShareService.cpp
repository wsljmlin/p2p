...
#ifdef SM_DBG
#define SHARESERVICE_PRT(fmt, arg...) fprintf(stdout, "[%s(%s):%d] "fmt, __FUNCTION__, "ShareService", __LINE__, ##arg)
#else
#define SHARESERVICE_PRT(fmt, arg...) 
#endif
...
int ShareService::ON_PTL_RequestFileBlocks(Peer* peer,PTLStream& ss)
{
	...
	SHARESERVICE_PRT("receive share block, and %s shared blocks..............\n", fi->path.c_str());
